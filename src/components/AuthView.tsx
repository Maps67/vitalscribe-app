...
import { Mail, Lock, User, Stethoscope, ArrowRight, AlertCircle, BadgeCheck, ShieldCheck } from 'lucide-react';
...
const AuthView: React.FC<AuthProps> = ({ authService, onLoginSuccess }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    licenseNumber: '', // Nuevo campo
    termsAccepted: false // Nuevo campo legal
  });
        ...
        const { error } = await authService.supabase.auth.signUp({
          ...
          options: {
            data: {
              ...
              license_number: formData.licenseNumber, // Enviamos la cédula
            },
          },
        });
